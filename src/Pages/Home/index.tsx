  ...
  return (
    <>
      ...
      <section className="grid grid-cols-2 text-slate-800 font-sans">
        <div className="grid w-3/12 ml-4 mt-16">
          <img className="w-44" src="leshop.png" alt="" />
          <div className="border-b border-slate-400 w-40 mt-5"></div>
          <h2 className="mt-3 text-sm">
            Cart
            <span className="ml-2 bg-red-600 text-white rounded-full px-1 font-semibold text-md">
              0
            </span>
          </h2>
          <div className="border-b border-slate-400 w-40 mt-3"></div>
